    ...
    return <Card className="m-auto d-block w-50 p-5 text-center">
        <form onSubmit={handleSubmit}>
            <div className="mb-4 w-full">
                ...
                <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="w-full block rounded-lg border dark:border-none dark:bg-neutral-600 py-2 px-3 pr-4 text-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none" />
            </div>
            <div className="mb-4 w-full">
                <label htmlFor="stamina">Hero Stamina</label>
                <input type="text" id="stamina" name="stamina" value={formData.stamina} onChange={handleChange} className="w-full block rounded-lg border dark:border-none dark:bg-neutral-600 py-2 px-3 pr-4 text-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none" />
            </div>
